...
### GOOGLE DRIVE LINK TO THE WHOLE NOTEBOOK (WITH RESULTS OF TRAJECTORY 01  IN THE OUTPUTS OF NOTEBOOK CELLS): https://drive.google.com/file/d/1F5FkOjZ9RbybxsUNMWaeG1lTO2nHG1lo/view
...
# y, sr = librosa.load("/content/drive/MyDrive/ROB 590/Audio files/Naya0___Rover_Audio.wav",sr=None)
...
# %%
"""
Trajectory No.01(run01 according to dataset provided by Jannik Zürn, Wolfram Burgard, Abhinav Valada
...
filename1 = '/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/GRAVEL_R01/GRAVEL_joined_R01.wav'


filename2 = '/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/ASPHALT_R01/R01_asphalt 0.wav'


filename3 = '/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/GRASS_R01/R01_grass 0.wav'


filename4 = '/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/COBBLE_R01/COBBLE_joined_R01.wav'



## class 0 = Gravel;  class 1 = asphalt


File_ = [filename1, filename2, filename3, filename4]
...
## DATA AUGMENTATION AND TIME DURATION EQUALIZATION
...
for key in TimeList.keys():
    ...
    if librosa.get_duration(y=y, sr=sr) == gravel:
      DictiZ['gravel'] = Equal_Time(audio=y,A=A)
    elif librosa.get_duration(y=y, sr=sr) == asphalt:
      DictiZ['asphalt'] = Equal_Time(audio=y,A=A)
    elif librosa.get_duration(y=y, sr=sr) == cobbelstone:
      DictiZ['cobbelstone'] = Equal_Time(audio=y,A=A)
    elif librosa.get_duration(y=y, sr=sr) == grass:
      DictiZ['grass'] = Equal_Time(audio=y,A=A)
    elif librosa.get_duration(y=y, sr=sr) == PL:
...
filename_= "/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/R01_Testing"   
...
for key in DictiZ.keys():
    filename = "/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/R01_Testing/" + key +"_Final" + '.wav'
   ...
   #  filename__ = "/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/R01_Testing/" + key+'_chunks'     
   #  os.mkdir(filename__)
    ...
    for i,chunk in enumerate(chunks):
       ...
       filename__ = "/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/R01_Testing/" + key+'_chunks' +'/chunk{0}.wav'.format(i)   
...
h_,w_,c_ = Dicti_Fin['gravel'][0].shape
...
network = network_architecture(input_shape,embeddingsize=len(TimeList))
...
triplets_train = random_triplets(5000,s='train')

# hardtriplets = hard_triplets(5000,1000,4000,network,s='train')


loss = network_train.fit(triplets_train ,batch_size= 64, epochs=100, validation_split=0.2)
...
network_train.save_weights('/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/Weights_R01_RANDOM/')
...
# %%
# save best hard triplet weights
network_train.save_weights('/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/Weights_R01/')
...
fpr, tpr, thresholds,auc = compute_metrics(probs,yprob)
draw_roc(fpr, tpr,thresholds)
draw_interdist(network,6300)

# %%
nb_classes = len(TimeList)
for i in range(nb_classes):
  print("Class {0}".format(i))
  AudioDist(network,np.expand_dims(Dataset_Train[i][0,:,:,:],axis=0))
