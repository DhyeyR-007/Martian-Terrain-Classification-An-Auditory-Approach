...
### GOOGLE DRIVE LINK TO THE WHOLE NOTEBOOK (WITH RESULTS ON ZUHRN DATASET TRAJECTORY 01  IN THE OUTPUTS OF NOTEBOOK CELLS): https://drive.google.com/file/d/1JCBm05ySkW2wfTgrkkU4M_sjpLu-fnF8/view
...
Mixed Signal: this is the raw audio signal that we get AFTER DATA SCRAPPING Zuhrn's dataset on trajectory 01

Separated Signal 1
Separated Signal 2
Separated Signal 3
Separated Signal 4
These are the four signals which the NMF (Non-Negative Matrix Factorization) method has separated. NMF is an unsupervised blind source separation method, on experimenting found to be more effective than ICA (Independent Component Analysis).(Incl. in ROB 590 report)

"""
# Load the mixed audio clip
# filename = '/content/drive/MyDrive/ROB 590/Audio files/Naya0___Rover_Audio.wav'
filename = '/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/ORIGINAL_R01/audio.wav'
...
# Function that uses all the aforementioned data augmentation techniques to equal the time duration of unequal audio splits (if present)
...
for i in range(len(y_separated)):
  ...
  sf.write('/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/ORIGINAL_R01/splitting audio/'+ str('Seg_Signal ' + str(i))+'.wav', new_audio, sr)


# %%
####################################### Zuhrn Trajectory 1 Audio ###########################################
...
for j in range(len(y_separated)):
  myaudio = AudioSegment.from_wav( '/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/ORIGINAL_R01/splitting audio/'+ str('Seg_Signal ' + str(j))+'.wav', "wav") 
  chunk_length_ms = 500 # pydub calculates in millisec = 2950 ; (320,320,l)=18575
  chunks = make_chunks(myaudio, chunk_length_ms) # Make chunks

  lisk = []
  #Export all of the individual chunks as wav files
  filename = "/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/ORIGINAL_R01/splitting audio/Splitted_seg_signal_" + str(j)
  # os.mkdir(filename)
  for i, chunk in enumerate(chunks): 
      ...
      # chunk.export("/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/ORIGINAL_R01/splitting audio/Splitted_seg_signal_" + str(j) + "/chunk{0}.wav".format(i), format="wav")
      lisk.append("/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/ORIGINAL_R01/splitting audio/Splitted_seg_signal_" + str(j) + "/chunk{0}.wav".format(i))
      MainList.append("/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/ORIGINAL_R01/splitting audio/Splitted_seg_signal_" + str(j) + "/chunk{0}.wav".format(i))
...
for i in DataDict:
  ...
  for j in range(len(DataDict[i])):
    ...
    # ps = librosa.feature.melspectrogram(y=y, sr=sr)   ## another audio feature extraction metric
...
# %%
# sanity checking the amount of train and test data
print(len(lisk_test_L[0]))
print(len(lisk_train_L[0]))
...
# then the inputs are passed into the neural net model which generates embeddings, now these embeddings can be use to calculate the distance 
# between the positive, negative and/or anchor, which can be used to compute triplet loss
# the last layer of the model architecture basically calculates triplet loss (that's what you see as output 'loss' while training)
...
row, col,channel = 128, 22, 1    ### <---------- change this accordingly to data
...
# %%
# SANITY CHECK working of neural net model
...
# %%
nb_classes = 4  ### <---------- change this accordingly to data (here we have 4 classes)
...
triplets_train = random_triplets(500,s='train')
...
network_train.save_weights('/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/ORIGINAL_R01/weights_RANDOM/')
...
hardtriplets = hard_triplets(500,200,300,network,s='train')
loss_ht = network_train.fit(hardtriplets,batch_size= 32, epochs=100, validation_split=0.2)

# %%
# save best hard triplet weights
network_train.save_weights('/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/ORIGINAL_R01/weights_HARD/')
...
# %%
network_train.load_weights("/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/ORIGINAL_R01/weights_HARD/checkpoint")
...
# %%
"""
NOW IN ORDER TO TEST THE VALIDITY OF OUR METHOD (NMF + SIAMESE NEURAL NET TRAINED ON TRAJECTORY 01 OF ZUHRN'S DATASET) WE TAKE TWO SAMPLES FROM TRAJECTORY NO.02 OF ZUHRN'S DATASET AND EVALUATE THEIR DISTANCE FROM THEIR CORRESPONDING CLASSES.
Trajectory No.01 & 02(according to dataset provided by Jannik Zürn, Wolfram Burgard, Abhinav Valada
...
filename1 = '/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R02/GRAVEL_R02/GRAVEL_joined_R02.wav'


filename2 = '/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R02/GRASS_R02/GRASS_joined_R02.wav'





File_ = [filename1, filename2]
...
NOW WE KNOW THAT GRAVEL AND GRASS BELONG TO THE AUDIO CLASSES SAME AS THAT OF SEPARATED SIGNAL 01 AND SEPARATED SIGNAL 02 RESPECTIVELY.

"""

# HERE WE TAKE DICTIONARY TO COLLECT THE GRASS AND GRAVEL AUDIO SIGNALS AS NUMPY ARRAYS
DictiZ = {}
...
## Now that we have two audio signals (one of gravel and one of grass), we split these segregated audios into chunks for training and testing data preparation ##
...
for key in DictiZ.keys():
    filename = "/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R02/R02_Testing/" + key +"_Final" + '.wav'
    myaudio = AudioSegment.from_wav( filename, "wav") 
    chunk_length_ms = 2950 # pydub calculates in millisec
    chunks = make_chunks(myaudio, chunk_length_ms) # Make chunks

    lisk = []

   #  filename__ = "/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R02/R02_Testing/" + key+'_chunks'     
   #  os.mkdir(filename__)
    ...
    for i,chunk in enumerate(chunks):
       ...
       filename__ = "/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R02/R02_Testing/" + key+'_chunks' +'/chunk{0}.wav'.format(i)   
      #  chunk.export(filename__, format="wav")   ### <--------- you can uncomment this to export and save the chunks to desired folder
...
# %%
## load the NMF based pre-trained hard triplet siamese neural net (trajectory 01 of Zuhrn's dataset) 
network_train.load_weights("/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R01/ORIGINAL_R01/weights_HARD/")

# %%
nb_classes = 2   ### <------ the no. of classes we are testing is 2 (gravel(class 0) and grass(class 1))
