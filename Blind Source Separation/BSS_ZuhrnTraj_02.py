...
### GOOGLE DRIVE LINK TO THE WHOLE NOTEBOOK (WITH RESULTS ON ZUHRN DATASET TRAJECTORY 02  IN THE OUTPUTS OF NOTEBOOK CELLS): https://drive.google.com/file/d/1rf0Dk3cgEf6s1Oopzsej2-eEi45P0evl/view
...
# %%
#if using google drive uncomment below lines
...
# here Separated Signal 1,2 are equivalent to two terrains
...
Mixed Signal: this is the raw audio signal that we get AFTER DATA SCRAPPING Zuhrn's dataset on trajectory 02

Separated Signal 1
Separated Signal 2

These are the two signals which the NMF (Non-Negative Matrix Factorization) method has separated. NMF is an unsupervised blind source separation method, on experimenting found to be more effective than ICA (Independent Component Analysis).(Incl. in ROB 590 report)


"""
# Load the mixed audio clip
# filename = '/content/drive/MyDrive/ROB 590/Audio files/Naya0___Rover_Audio.wav'
filename = '/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R02/ORIGINAL_R02/audio.wav'
...
for i in range(len(y_separated)):
  ...
  sf.write('/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R02/ORIGINAL_R02/splitting audio/' + str('Seg_Signal ' + str(i))+'.wav', new_audio, sr)


# %%
####################################### Zuhrn Trajectory 2 Audio ###########################################
...
DataDict = {'Signal_0':None, 'Signal_1':None}
MainList = []

for j in range(len(y_separated)):
  myaudio = AudioSegment.from_wav( '/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R02/ORIGINAL_R02/splitting audio/'+ str('Seg_Signal ' + str(j))+'.wav', "wav") 
  ...
  filename = "/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R02/ORIGINAL_R02/splitting audio/Splitted_seg_signal_" + str(j)
  os.mkdir(filename)
  for i, chunk in enumerate(chunks): 
      ...
      file_name = "/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R02/ORIGINAL_R02/splitting audio/Splitted_seg_signal_"

      chunk.export( file_name + str(j) + "/chunk{0}.wav".format(i), format="wav")
      lisk.append(file_name + str(j) + "/chunk{0}.wav".format(i))
      MainList.append(file_name + str(j) + "/chunk{0}.wav".format(i))
...
Dicti = {'Signal_0': None, 'Signal_1': None}
...
network = network_architecture(input_shape,embeddingsize=2)
...
network_train.save_weights('/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R02/ORIGINAL_R02/weights_RANDOM/')
...
network_train.save_weights('/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R02/ORIGINAL_R02/weights_HARD/')
...
# %%
"""
NOW IN ORDER TO TEST THE VALIDITY OF OUR METHOD (NMF + SIAMESE NEURAL NET TRAINED ON TRAJECTORY 02 OF ZUHRN'S DATASET) WE TAKE TWO RANDOM SAMPLES FROM TRAJECTORY NO.02 OF ZUHRN'S DATASET AND EVALUATE THEIR DISTANCE FROM THEIR CORRESPONDING CLASSES.

For all 3 trajectories 01, 02 and 12 of Zuhrn's datset we are evaluting using the data from teajectory no.02 since this provides a fair compariosn of the metrics
tabulated in the ROB 590 report.

Trajectory No.02(according to dataset provided by Jannik Zürn, Wolfram Burgard, Abhinav Valada
...
# %%
network_train.load_weights("/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R02/ORIGINAL_R02/weights_HARD/")
