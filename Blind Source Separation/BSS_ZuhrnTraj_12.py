...
### GOOGLE DRIVE LINK TO THE WHOLE NOTEBOOK (WITH RESULTS ON ZUHRN DATASET TRAJECTORY 12  IN THE OUTPUTS OF NOTEBOOK CELLS): https://drive.google.com/file/d/1CecJq5FgugOmg0LTXKx1Qb93I3D1vGLH/view
...
# here Separated Signal 1,2,3,4 & 5 are equivalent to five terrains
...
# FIVE TERRAINS:
    # Separated Signal 1 = GRAVEL  
    # Separated Signal 2 = ASPHALT   
    # Separated Signal 3 = GRASS
    # Separated Signal 4 = COBBLE
    # Separated Signal 5 = PL {Parking Lot}
...
Separated Signal 4
Separated Signal 5
These are the five signals which the NMF (Non-Negative Matrix Factorization) method has separated. NMF is an unsupervised blind source separation method, on experimenting found to be more effective than ICA (Independent Component Analysis).(explanation incl. in ROB 590 report)
...
filename = '/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R12/ORIGINAL_R12/audio.wav'
...
for i in range(len(y_separated)):
  ...
  sf.write('/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R12/ORIGINAL_R12/splitting audio/' + str('Seg_Signal ' + str(i))+'.wav', new_audio, sr)


# %%
####################################### Zuhrn Trajectory 12 Audio ###########################################
...
for j in range(len(y_separated)):
  myaudio = AudioSegment.from_wav( '/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R12/ORIGINAL_R12/splitting audio/'+ str('Seg_Signal ' + str(j))+'.wav', "wav") 
  ...
  filename = "/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R12/ORIGINAL_R12/splitting audio/Splitted_seg_signal_" + str(j)
  os.mkdir(filename)
  for i, chunk in enumerate(chunks): 
      ...
      file_name = "/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R12/ORIGINAL_R12/splitting audio/Splitted_seg_signal_"
...
Dicti = {'Signal_0': None, 'Signal_1': None, 'Signal_2': None, 'Signal_3': None, 'Signal_4': None}
...
network = network_architecture(input_shape,embeddingsize=len(Dicti))
...
network_train.save_weights('/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R12/ORIGINAL_R12/weights_RANDOM/')
...
network_train.save_weights('/home/drajani/Downloads/ROB 590-20230406T190632Z-001-20230406T191441Z-001/ROB 590-20230406T190632Z-001/ROB 590/ZUHRN_AUDIO/R12/ORIGINAL_R12/weights_HARD/')
